...
import {
  ...
  TrendingDown, Activity, Shield, PieChart
} from "lucide-react";
import {
  LineChart,
  Line,
...
export default function Step3() {
  ...
  // Enhanced mock data with more detailed analysis
  ...
  // Enhanced price history data with more data points
  const priceHistoryData = [
    { month: "Юли", value: mockEvaluation.estimatedValue * 0.85 },
    { month: "Авг", value: mockEvaluation.estimatedValue * 0.87 },
    { month: "Сеп", value: mockEvaluation.estimatedValue * 0.90 },
                ...
                <div className="text-center py-8 relative">
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-300 mt-2">
                      {formatCurrency(mockEvaluation.pricePerSquareMeter)}/м²
                    </p>
                  </motion.div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
            <div className="bg-gradient-to-r from-gray-50 to-white p-4 rounded-xl border shadow-sm">
              <TabsList className="grid grid-cols-2 lg:grid-cols-6 gap-4">
                <TabsTrigger value="overview" className="flex items-center gap-3 p-3 data-[state=active]:bg-gradient-to-br data-[state=active]:from-primary/10 data-[state=active]:to-primary/5 data-[state=active]:text-primary hover:bg-gray-50 transition-all">
                ...
                <TabsTrigger value="market" className="flex items-center gap-3 p-3 data-[state=active]:bg-gradient-to-br data-[state=active]:from-blue-50 data-[state=active]:to-blue-50/50 data-[state=active]:text-blue-600 hover:bg-gray-50 transition-all">
                ...
                <TabsTrigger value="location" className="flex items-center gap-3 p-3 data-[state=active]:bg-gradient-to-br data-[state=active]:from-purple-50 data-[state=active]:to-purple-50/50 data-[state=active]:text-purple-600 hover:bg-gray-50 transition-all">
                  <div className="p-2 bg-gradient-to-br from-purple-50 to-purple-50/50 rounded-lg">
                    <MapPin className="h-5 w-5" />
                  </div>
                  <span className="font-medium">Локация</span>
                </TabsTrigger>
                <TabsTrigger value="comparison" className="flex items-center gap-3 p-3 data-[state=active]:bg-gradient-to-br data-[state=active]:from-green-50 data-[state=active]:to-green-50/50 data-[state=active]:text-green-600 hover:bg-gray-50 transition-all">
                ...
                <TabsTrigger value="risk" className="flex items-center gap-3 p-3 data-[state=active]:bg-gradient-to-br data-[state=active]:from-yellow-50 data-[state=active]:to-yellow-50/50 data-[state=active]:text-yellow-600 hover:bg-gray-50 transition-all">
                ...
                <TabsTrigger value="documents" className="flex items-center gap-3 p-3 data-[state=active]:bg-gradient-to-br data-[state=active]:from-orange-50 data-[state=active]:to-orange-50/50 data-[state=active]:text-orange-600 hover:bg-gray-50 transition-all">
                      ...
                      <CardContent>
                        <div className="grid grid-cols-2 gap-4">
                          {marketMetrics.map((metric, index) => (
                            <div key={index} className={`p-4 bg-gradient-to-br from-${metric.trend === 'up' ? 'green' : metric.trend === 'down' ? 'red' : 'blue'}-50 to-white rounded-xl border`}>
                              <div className="text-center">
                                <div className={`mb-2 inline-flex items-center justify-center w-10 h-10 rounded-full bg-${metric.trend === 'up' ? 'green' : metric.trend === 'down' ? 'red' : 'blue'}-100`}>
                                  {metric.trend === 'up' ? <TrendingUp className="h-5 w-5 text-green-600" /> : metric.trend === 'down' ? <TrendingDown className="h-5 w-5 text-red-600" /> : <Activity className="h-5 w-5 text-blue-600" />}
                                </div>
                                <div className={`font-semibold text-lg text-${metric.trend === 'up' ? 'green' : metric.trend === 'down' ? 'red' : 'blue'}-600`}>
                                  {metric.value}
                                </div>
                                <div className="text-sm text-gray-600">
                                  {metric.name}
